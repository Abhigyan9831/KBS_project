    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            {/* Mobile Layout - Text positioned in empty spaces around the centered person */}
            {isMobile ? (
              <div className="h-full relative">
                {/* Top Left - Premium Quality */}
                <div
                  className="absolute"
                  style={{
                    top: '90px',
                ...
                {/* Top Right - Fast & Reliable Delivery */}
                <div
                ...
                >
                  <h2 className={`section3-heading section3-reveal-inner ${textRevealed ? 'revealed' : ''}`}
                      style={{ transitionDelay: '0s', fontSize: 'clamp(24px, 6vw, 32px)' }}>
                    Why Us?
                  </h2>
                </div>
              </div>
